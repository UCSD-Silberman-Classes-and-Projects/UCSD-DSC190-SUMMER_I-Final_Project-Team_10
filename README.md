...
| 1a. Adaptive speed control    | ✅ Working  | Steering angle scales with throttle for line following — car adjusts its respective steering angle depending on manually-controlled speed, keeping turns tracked at both low and high throttle.                                                                                                       |
| 2. Lane following              | 🟡 Partly Working | Drives a chosen lane between two yellow boundaries and a discontinuous center divider; mode and lane switch live from a web toggle page.                                                                                                                                                               |
...
| 4. Documentation                | ✅ Complete | Mission stages, architecture, and development process written up for handoff/reference.                                                                                                                                                                                                                |
